    ...
    >
        ...
        <v-tooltip bottom open-delay="300">
          <template v-slot:activator="{ on: tooltip }">
            <v-btn icon small v-bind="{ attrs }" v-on="{ ...tooltip, ...menu }">
              <v-icon small class="button-icon"> mdi-sort </v-icon>
            </v-btn>
          </template>
      ...
      <v-list dense width="180">
        ...
        <v-list-item-group
          ...
          @change="onChange"
        >
          <v-list-item v-for="sort in sortMethods" :key="sort.id">
            <v-list-item-title>
        ...
        <v-list-item-group
          ...
          @change="onChange"
        >
          <v-list-item v-for="direction in sortDirections" :key="direction.id">
            <v-list-item-title>
